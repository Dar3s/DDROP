...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    // DEBUG (když chceš vidět co API vrací)
    // echo "<pre>".htmlspecialchars($response)."</pre>"; exit;
    ...
    <section class="auth-page">
        ...
        <div class="info-card">
            ...
            <ul class="account-list">
                ...
                <li>Personalizované řazení</li>
                <li>Marketplace profil</li>
                <li>Watchlisty a notifikace</li>
            </ul>
        </div>
    </section>
</body>
