        ...
        <div class="auth-card">
            ...
            <form method="POST" action="login.php">
                <div class="form-group">
                    ...
                    <input class="form-input" type="email" id="email" name="email" placeholder="Tvůj email" required>
                </div>

                <div class="form-group">
                    <label class="form-label" for="password">Heslo</label>
                    <input class="form-input" type="password" id="password" name="password" placeholder="Tvoje heslo" required>
                </div>
